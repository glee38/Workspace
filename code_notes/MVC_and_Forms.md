...
The strings are concatenated (joined together) first, then displayed on the page. Below this, add the following lines of code:
...
```ruby
<% wall_posts = ["First post!", "Second post!", 
"Hello, it's your mother, why don't you ever call me?"] %>
```
